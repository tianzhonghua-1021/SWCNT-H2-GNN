...
dataset_cache_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../results/graph_tp_tda/dmpnn_dataset_cache'))  # cache folder
...
def plot_overfitting_check_gnn(all_preds, y_true, save_dir):
    ...
    plt.hist(r2_scores, bins=10, alpha=0.6, color='steelblue')
...
SAVE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../results/graph_tp_tda'))
